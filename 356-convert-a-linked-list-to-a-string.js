...
function stringify(list) {
  ...
  //   let result = ""; // untuk menampung string akhir
  //   let current = list; // mulai dari node pertama

  //   while (current !== null) {
  //     result += current.data + " -> "; // tambahkan data node dan " -> "
  //     current = current.next; // pindah ke node berikutnya
  //   }

  //   result += "null"; // tambahkan null di akhir
  //   return result;
